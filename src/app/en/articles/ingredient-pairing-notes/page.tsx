...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"ingredient-pairing-notes"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"ingredient-pairing-notes"}, Impl);
