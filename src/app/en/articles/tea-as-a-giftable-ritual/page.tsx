...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"tea-as-a-giftable-ritual"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"tea-as-a-giftable-ritual"}, Impl);
