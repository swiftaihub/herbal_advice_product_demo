...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"american-ginseng"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"american-ginseng"}, Impl);
