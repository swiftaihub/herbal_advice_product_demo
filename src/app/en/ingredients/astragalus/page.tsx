...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"astragalus"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"astragalus"}, Impl);
