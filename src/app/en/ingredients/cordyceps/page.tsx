...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"cordyceps"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"cordyceps"}, Impl);
