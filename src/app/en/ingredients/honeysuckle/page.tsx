...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"honeysuckle"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"honeysuckle"}, Impl);
