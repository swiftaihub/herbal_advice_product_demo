...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"amber-silk-restore-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"amber-silk-restore-tea"}, Impl);
