...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"citrus-cloud-harmony-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"citrus-cloud-harmony-tea"}, Impl);
