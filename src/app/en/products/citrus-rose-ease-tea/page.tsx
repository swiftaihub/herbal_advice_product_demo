...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"citrus-rose-ease-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"citrus-rose-ease-tea"}, Impl);
