...
export const generateMetadata = wrapFixedLocaleMetadata("en", {"slug":"dewlight-replenish-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("en", {"slug":"dewlight-replenish-tea"}, Impl);
