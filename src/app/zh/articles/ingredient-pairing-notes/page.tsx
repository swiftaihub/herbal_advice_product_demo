...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"ingredient-pairing-notes"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"ingredient-pairing-notes"}, Impl);
