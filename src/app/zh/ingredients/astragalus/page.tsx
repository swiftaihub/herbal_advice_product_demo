...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"astragalus"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"astragalus"}, Impl);
