...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"chrysanthemum"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"chrysanthemum"}, Impl);
