...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"cordyceps"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"cordyceps"}, Impl);
