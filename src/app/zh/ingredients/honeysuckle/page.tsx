...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"honeysuckle"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"honeysuckle"}, Impl);
