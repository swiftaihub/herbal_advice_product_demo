...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"huangjing"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"huangjing"}, Impl);
