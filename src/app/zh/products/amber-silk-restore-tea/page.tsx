...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"amber-silk-restore-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"amber-silk-restore-tea"}, Impl);
