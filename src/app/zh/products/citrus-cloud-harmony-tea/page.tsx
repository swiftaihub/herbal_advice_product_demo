...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"citrus-cloud-harmony-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"citrus-cloud-harmony-tea"}, Impl);
