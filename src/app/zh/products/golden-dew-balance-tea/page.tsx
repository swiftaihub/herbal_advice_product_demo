...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"golden-dew-balance-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"golden-dew-balance-tea"}, Impl);
