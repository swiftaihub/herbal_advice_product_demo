...
export const generateMetadata = wrapFixedLocaleMetadata("zh", {"slug":"zaoxi-vitality-tea"}, generateSourceMetadata);
export default wrapFixedLocalePage("zh", {"slug":"zaoxi-vitality-tea"}, Impl);
